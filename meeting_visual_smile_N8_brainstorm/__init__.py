...
class C(BaseConstants):
  NAME_IN_URL = 'meeting_visual_smile_N8_brainstorm'
  PLAYERS_PER_GROUP = 2
  NUM_ROUNDS = 4
  TOPICS = [ ("RespectEnvironment"    ,  "During the next interaction, we would like you to brainstorm with the other person about novel ways to respect the environment.")
          , ("ReducePolution"         ,  "During the next interaction, we would like you to brainstorm with the other person about novel ways to reduce environmental polution.")
          , ("ImproveHealth"          ,  "During the next interaction, we would like you to brainstorm with the other person about ways to improve the health of humans in our society.")
          , ("GlobalWarming"          , "During the next interaction, we would like you to brainstorm with the other person about ways to deal with global warming both at a personal and a societal level.")
          ]
  shuffle(TOPICS)
...
class ProlificCompensation(Page):
  template_name = 'brainstorm_prolific_smile_video/ProlificCompensation.html'
...
# ----------------------------------------
page_sequence = [BaseIntroduction, BaseSettings, BaseWaitForAll, TopicInstructions, BrainstormWaitBeforeInteract, Interact, BrainstormComment, BrainstormDebriefing1, BrainstormDebriefing2, ProlificCompensation]